						...
						@include('alerts.request')
							{!!Form::open(['route' => 'register.store', 'method'=>'POST', 'class'=>'form-horizontal'])!!}
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										{!! Form::number('cuatrimestre', null, ['class' => 'form-control col-sm-8','placeholder' => 'Ingresa tu cuatrimestre', 'min' => '1', 'max' => '15']) !!}
									</div>		
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										{!! Form::select('carrera', ['Ing. en Desarrollo de Software' => 'Ing. en Desarrollo de Software'], null, ['class' => 'form-control col-sm-8']) !!}
									</div>
								</div>						
